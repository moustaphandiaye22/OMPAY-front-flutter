...
class OrangeMoneyLoginPage extends StatelessWidget {
  ...
  void _handleLogin(BuildContext context, AuthProvider authProvider) async {
    ...
    print('📊 After requestOTP: isOTPRequested=${authProvider.isOTPRequested}, errorMessage=${authProvider.errorMessage}');

    // Navigation vers la page OTP si pas d'erreur (même si l'état n'est pas parfait)
    if (authProvider.errorMessage == null) {
      ...
      print('❌ Not navigating due to error: ${authProvider.errorMessage}');
    }
  }
          ...
          children: [
            ...
            Stack(
              children: [
                ...
                // Titre et description (positionnés au-dessus)
                Positioned(
                  top: 140,
                  left: 0,
                  right: 0,
